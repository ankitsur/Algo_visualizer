...
Distance = [[1000000 for x in range(w)] for y in range(h)]
...
def colorTheBoxes():
    for x in color:
        pg.draw.rect(screen,(0,0,255),(x[0]*4,x[1]*4,4,4),0)
...
def drawLines():
    for i in range(1,150):
        pg.draw.line(screen,(0,0,0),(4*i - 1,0),(4*i - 1,600),1)
        pg.draw.line(screen,(0,0,0),(0,4*i - 1),(600,4*i - 1),1)
    ...
    if eventsDone == 0:
        ...
        if eventsDone >= 1:
            if eventsDone == 1:
                ...
                textRect.center = (300, 19)
                screen.blit(text, textRect)
            pg.draw.rect(screen,(0,0,0),(Xstart*4,Ystart*4,4,4),0)
            if(eventsDone >= 2):
                if(eventsDone == 2):
                    pg.draw.rect(screen, (0, 200, 200), (0, 0, 600, 38), 0)
                    pg.draw.line(screen, (0, 0, 0), (0, 38), (600, 38), 2)
                ...
                pg.draw.rect(screen, (0, 0, 0), (Xend * 4, Yend * 4, 4, 4), 0)
                if(eventsDone == 3):
                    pg.draw.rect(screen, (0, 200, 200), (0, 0, 600, 38), 0)
                    pg.draw.line(screen, (0, 0, 0), (0, 38), (600, 38), 2)
                    ...
                    screen.blit(text, textRect)
                for x in walls:
                    pg.draw.rect(screen,(0,0,0),(x[0]*4,x[1]*4,4,4),0)
while(loop):
    for event in pg.event.get():
        if event.type == pg.QUIT:
            loop = False
            ...
            if pg.mouse.get_pressed() == (1,0,0) and eventsDone <= 3:
                ...
                if(eventsDone == 0):
                    ...
                    if(eventsDone == 1):
                        ...
                        for x in range(150):
                            for y in range(150):
                                Distance[x][y] = abs(Xend - x) + abs(Yend - y)
                                print(Distance[x][y])
                        eventsDone += 1
                    else:
                        if(eventsDone == 2):
